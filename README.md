...
To use the package, you need install [SymEngine](https://github.com/symengine/SymEngine.jl)  and  [InvertedIndices](https://github.com/JuliaData/InvertedIndices.jl)
